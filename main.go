...
func writeMP4Tags(trackPath string, meta *structs.AutoGenerated, trackNum, trackTotal int) error {
	index := trackNum - 1
	year, err := strconv.ParseInt(meta.Data[0].Relationships.Tracks.Data[index].Attributes.ReleaseDate[:4], 10, 32)
	if err != nil {
		return err
	}
	...
	t := &mp4tag.MP4Tags{
		...
		Date:         meta.Data[0].Relationships.Tracks.Data[index].Attributes.ReleaseDate,
